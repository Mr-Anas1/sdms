...
// Ensure this route runs on Node.js (not Edge) on Vercel
export const runtime = "nodejs";
// Avoid caching of this route
      ...
      <div style="font-family: Arial, sans-serif; background-color: #000; color: #fff; padding: 20px; border-radius: 10px; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; background-color: #000;">
          ...
          <ul style="list-style: none; padding: 0;">
            <li style="color: #fff; margin-bottom: 8px;"><strong style="color: #8A2BE2;">Name:</strong> ${name}</li>
            <li style="color: #fff; margin-bottom: 8px;"><strong style="color: #8A2BE2;">Email:</strong> ${email}</li>
